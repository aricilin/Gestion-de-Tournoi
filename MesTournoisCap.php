...
<tr>
      ...
      <td><?php echo $tournois['idTournoi'] ?></td>
		...
		<td><a href="ArbreDesMatchesCap.php?idTournoi=<?php echo $tournois['idTournoi'] ?>&nbequipes=<?php echo $tournois['nombreEquipes']?>"><button>Voir les matches</button></td>
<?php } ?>
...
<tr>
      ...
      <td><?php echo $tournois2['idTournoi'] ?></td>
		...
		<td><a href="ArbreDesMatchesCap.php?idTournoi=<?php echo $tournois2['idTournoi'] ?>&nbequipes=<?php echo $tournois2['nombreEquipes']?>"><button>Voir les matches</button></td>
<?php } ?>
</table>
</div>
</div>
