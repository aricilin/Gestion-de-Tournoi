...
<tr>
    ...
    <td><a href="arbreTournoiGest.php?nombreEquipes=<?php echo $turnuvacek['nombreEquipes']?>&idTournoi=<?php echo $turnuvacek['idTournoi'] ?>"><button>Arbre de tournoi</button></td>
